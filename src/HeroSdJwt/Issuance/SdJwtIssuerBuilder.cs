...
/// </code>
/// </example>
public class SdJwtIssuerBuilder
{
    ...
    public SdJwtIssuerBuilder WithClaim(string name, object value)
    {
        _claims ??= [];
        _claims[name] = value;
        return this;
    ...
    public SdJwtIssuerBuilder MakeSelective(params string[] claimNames)
    {
    ...
    public SdJwtIssuerBuilder SignWithEd25519(byte[] privateKey)
    {
        _signingKey = privateKey ?? throw new ArgumentNullException(nameof(privateKey));
    ...
    public SdJwtIssuerBuilder WithHashAlgorithm(HashAlgorithm algorithm)
    {
    ...
    public SdJwtIssuerBuilder WithKeyBinding(byte[] holderPublicKey)
    {
